...
export class Dropdown extends Component {
  ...
  renderClearIcon() {
    if (this.props.value != null && this.props.showClear && !this.props.disabled) {
      return (
        <i className="p-dropdown-clear-icon" onClick={this.clear}>
          <FiX />
        </i>
      );
    } else {
  ...
  renderDropdownIcon() {
    return (
      <div className="p-dropdown-trigger" role="button" aria-haspopup="listbox" aria-expanded={this.state.overlayVisible}>
        <span className="p-dropdown-trigger-icon p-clickable">
          <FiChevronDown />
        </span>
      </div>
    );
    ...
    if (this.props.filter) {
      return (
        <div className="p-dropdown-filter-container">
          ...
          />
          <span className="p-dropdown-filter-icon">
            <FiSearch />
          </span>
        </div>
      );
