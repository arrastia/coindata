...
import Tooltip from 'interfaces/views/.components/Tooltip';
...
export class Calendar extends Component {
  ...
  updateFocus() {
    ...
    if (this.navigation) {
      if (this.navigation.button) {
        ...
        if (this.navigation.backward) DomHandler.findSingle(this.panel, '.p-datepicker-prev').focus();
  ...
  initFocusableCell() {
    ...
    if (this.view === 'month') {
      ...
      if (!cell) {
        ...
        else cell = DomHandler.findSingle(this.panel, '.p-datepicker-calendar td span:not(.p-disabled)');
      }
    }
  ...
  alignPanel() {
    if (this.props.touchUI) {
      ...
      } else DomHandler.relativePosition(this.panel, this.inputElement);
    }
  }
  ...
  renderTitleMonthElement(month) {
    if (this.props.monthNavigator && this.props.view !== 'month') {
      ...
      return <span className="p-datepicker-month">{this.props.locale.monthNames[month]}</span>;
    }
  }
  ...
  renderMonth(monthMetaData, index) {
    ...
    const forwardNavigator =
      this.props.numberOfMonths === 1 || index === this.props.numberOfMonths - 1 ? this.renderForwardNavigator() : null;
