...
import { Paginator } from 'interfaces/views/.components/Paginator';
...
export class DataTable extends Component {
  ...
  getStorage() {
    switch (this.props.stateStorage) {
      ...
      default:
        throw new Error(
          this.props.stateStorage + ' is not a valid value for the state storage, supported values are "local" and "session".'
        );
    }
  }
