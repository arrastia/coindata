...
import { RowCheckbox } from 'interfaces/views/.components/DataTable/.components/RowCheckbox';
  ...
  render() {
    ...
    if (this.props.columnProps.filter && this.props.renderOptions.renderFilter) {
      ...
      filterElement = this.props.columnProps.filterElement || (
        <InputText
          ...
          defaultValue={
            this.props.filters && this.props.filters[filterField] ? this.props.filters[filterField].value : null
          }
    ...
    if (this.props.renderOptions.filterOnly) {
      ...
      let resizer = this.props.resizableColumns && (
        <span className="p-column-resizer p-clickable" onMouseDown={this.onResizerMouseDown}></span>
      );
