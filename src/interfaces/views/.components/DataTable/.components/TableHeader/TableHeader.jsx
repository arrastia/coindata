  ...
  render() {
    ...
    if (this.props.columnGroup) {
      ...
      content = rows.map((row, i) => {
        return (
          <tr key={i}>
            {this.createHeaderCells(React.Children.toArray(row.props.children), {
              filterOnly: false,
              renderFilter: true,
      ...
      if (this.hasColumnFilter(columns)) {
        content = (
          <>
            <tr>
              {this.createHeaderCells(columns, { filterOnly: false, renderFilter: false, renderHeaderCheckbox: false })}
            </tr>
            <tr>
              {this.createHeaderCells(columns, { filterOnly: true, renderFilter: true, renderHeaderCheckbox: true })}
            </tr>
          </>
        );
      } else {
        content = (
          <tr>
            {this.createHeaderCells(columns, { filterOnly: false, renderFilter: false, renderHeaderCheckbox: true })}
          </tr>
        );
      }
    }
