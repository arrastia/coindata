...
import { RowTogglerButton } from './.components/RowTogglerButton';
...
export class TableBody extends Component {
  ...
  renderRowGroupHeader(rowData, index) {
    ...
    if (this.props.rowGroupMode === 'subheader' && this.props.expandableRowGroups) {
      content = (
        <RowTogglerButton onClick={this.onRowToggle} rowData={rowData} expanded={this.isRowExpanded(rowData)} />
      );
    }
  ...
  render() {
    ...
    if (this.props.value && this.props.value.length) {
      ...
      rows =
        !this.props.loading && emptyMessage ? (
